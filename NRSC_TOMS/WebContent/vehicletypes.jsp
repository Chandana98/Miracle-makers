...
<h2 align="center"> Vehicle Types </h2>
...
<td><button type="submit" name="submitvehtype" value=<%=idsno %> style="background-color:#49743D;font-weight:bold;color:#ffffff;">Update</button></td>
